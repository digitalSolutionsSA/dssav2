  ...
  return (
    <section className="relative w-full h-full bg-white overflow-hidden flex flex-col">
      ...
      <div className="relative z-10 flex-1 flex flex-col items-center justify-center text-center px-6 md:px-[8%] gap-4 md:gap-6">
        ...
        >
          We believe great digital experiences do more than look beautiful — they create connections,
          build trust, and inspire action. At Digital Solutions SA, we combine strategy, creativity,
          and technology to help businesses stand out in an increasingly digital world. From websites
          and applications to AI solutions and digital marketing, we craft experiences that drive growth
      ...
      >
        <p className="text-black leading-none"
          ...
          <span style={{ fontWeight: 200 }}>ABOUT </span>
